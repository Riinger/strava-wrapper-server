...
public class PowerStream {
  ...
  public PowerStream originalSize(@Nullable Integer originalSize) {
  ...
  public PowerStream resolution(@Nullable ResolutionEnum resolution) {
  ...
  public PowerStream seriesType(@Nullable SeriesTypeEnum seriesType) {
  ...
  @Schema(name = "data", description = "The sequence of power values for this stream, in watts", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("data")
