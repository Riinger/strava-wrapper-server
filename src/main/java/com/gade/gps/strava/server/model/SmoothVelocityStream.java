...
public class SmoothVelocityStream {
  ...
  public SmoothVelocityStream originalSize(@Nullable Integer originalSize) {
  ...
  public SmoothVelocityStream resolution(@Nullable ResolutionEnum resolution) {
  ...
  public SmoothVelocityStream seriesType(@Nullable SeriesTypeEnum seriesType) {
  ...
  @Schema(name = "data", description = "The sequence of velocity values for this stream, in meters per second", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("data")
