...
public class SmoothGradeStream {
  ...
  public SmoothGradeStream originalSize(@Nullable Integer originalSize) {
  ...
  public SmoothGradeStream resolution(@Nullable ResolutionEnum resolution) {
  ...
  public SmoothGradeStream seriesType(@Nullable SeriesTypeEnum seriesType) {
  ...
  @Schema(name = "data", description = "The sequence of grade values for this stream, as percents of a grade", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("data")
