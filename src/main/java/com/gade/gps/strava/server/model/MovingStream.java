...
public class MovingStream {
  ...
  public MovingStream originalSize(@Nullable Integer originalSize) {
  ...
  public MovingStream resolution(@Nullable ResolutionEnum resolution) {
  ...
  public MovingStream seriesType(@Nullable SeriesTypeEnum seriesType) {
  ...
  @Schema(name = "data", description = "The sequence of moving values for this stream, as boolean values", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("data")
