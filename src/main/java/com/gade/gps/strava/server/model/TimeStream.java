...
public class TimeStream {
  ...
  public TimeStream originalSize(@Nullable Integer originalSize) {
  ...
  public TimeStream resolution(@Nullable ResolutionEnum resolution) {
  ...
  public TimeStream seriesType(@Nullable SeriesTypeEnum seriesType) {
  ...
  @Schema(name = "data", description = "The sequence of time values for this stream, in seconds", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("data")
