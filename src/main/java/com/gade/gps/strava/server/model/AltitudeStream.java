...
public class AltitudeStream {
  ...
  public AltitudeStream originalSize(@Nullable Integer originalSize) {
  ...
  public AltitudeStream resolution(@Nullable ResolutionEnum resolution) {
  ...
  public AltitudeStream seriesType(@Nullable SeriesTypeEnum seriesType) {
  ...
  @Schema(name = "data", description = "The sequence of altitude values for this stream, in meters", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("data")
