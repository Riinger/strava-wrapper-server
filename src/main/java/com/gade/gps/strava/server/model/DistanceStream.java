...
public class DistanceStream {
  ...
  public DistanceStream originalSize(@Nullable Integer originalSize) {
  ...
  public DistanceStream resolution(@Nullable ResolutionEnum resolution) {
  ...
  public DistanceStream seriesType(@Nullable SeriesTypeEnum seriesType) {
  ...
  @Schema(name = "data", description = "The sequence of distance values for this stream, in meters", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("data")
