...
import com.gade.gps.strava.server.model.DetailedSegmentEffort;
import com.gade.gps.strava.server.model.Lap;
import com.gade.gps.strava.server.model.MetaAthlete;
import com.gade.gps.strava.server.model.PhotosSummary;
import com.gade.gps.strava.server.model.PolylineMap;
import com.gade.gps.strava.server.model.Split;
...
public class DetailedActivity {
  ...
  private @Nullable PhotosSummary photos;

  private @Nullable SummaryGear gear;

  private @Nullable Float calories;

  @Valid
  private List<DetailedSegmentEffort> segmentEfforts = new ArrayList<>();

  private @Nullable String embedToken;

  @Valid
  private List<@Valid Split> splitsMetric = new ArrayList<>();

  @Valid
  private List<@Valid Split> splitsStandard = new ArrayList<>();

  @Valid
  private List<@Valid Lap> laps = new ArrayList<>();

  @Valid
  private List<DetailedSegmentEffort> bestEfforts = new ArrayList<>();

  public DetailedActivity id(@Nullable Long id) {
    this.id = id;
    return this;
  }
  ...
  public DetailedActivity externalId(@Nullable String externalId) {
  ...
  public DetailedActivity uploadId(@Nullable Long uploadId) {
  ...
  public DetailedActivity athlete(@Nullable MetaAthlete athlete) {
  ...
  public DetailedActivity name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public DetailedActivity distance(@Nullable Float distance) {
  ...
  public DetailedActivity movingTime(@Nullable Integer movingTime) {
  ...
  public DetailedActivity elapsedTime(@Nullable Integer elapsedTime) {
  ...
  public DetailedActivity totalElevationGain(@Nullable Float totalElevationGain) {
  ...
  public DetailedActivity elevHigh(@Nullable Float elevHigh) {
  ...
  public DetailedActivity elevLow(@Nullable Float elevLow) {
  ...
  public DetailedActivity type(@Nullable ActivityType type) {
    this.type = type;
    return this;
  }
  ...
  public DetailedActivity sportType(@Nullable SportType sportType) {
  ...
  public DetailedActivity startDate(@Nullable OffsetDateTime startDate) {
  ...
  public DetailedActivity startDateLocal(@Nullable OffsetDateTime startDateLocal) {
  ...
  public DetailedActivity timezone(@Nullable String timezone) {
  ...
  public DetailedActivity startLatlng(List<Float> startLatlng) {
  ...
  public DetailedActivity endLatlng(List<Float> endLatlng) {
  ...
  public DetailedActivity achievementCount(@Nullable Integer achievementCount) {
  ...
  public DetailedActivity kudosCount(@Nullable Integer kudosCount) {
  ...
  public DetailedActivity commentCount(@Nullable Integer commentCount) {
  ...
  public DetailedActivity athleteCount(@Nullable Integer athleteCount) {
  ...
  public DetailedActivity photoCount(@Nullable Integer photoCount) {
  ...
  public DetailedActivity totalPhotoCount(@Nullable Integer totalPhotoCount) {
  ...
  public DetailedActivity map(@Nullable PolylineMap map) {
    this.map = map;
    return this;
  }
  ...
  public DetailedActivity deviceName(@Nullable String deviceName) {
  ...
  public DetailedActivity trainer(@Nullable Boolean trainer) {
  ...
  public DetailedActivity commute(@Nullable Boolean commute) {
  ...
  public DetailedActivity manual(@Nullable Boolean manual) {
    this.manual = manual;
    return this;
  }
  ...
  public DetailedActivity _private(@Nullable Boolean _private) {
  ...
  public DetailedActivity flagged(@Nullable Boolean flagged) {
  ...
  public DetailedActivity workoutType(@Nullable Integer workoutType) {
  ...
  public DetailedActivity uploadIdStr(@Nullable String uploadIdStr) {
  ...
  public DetailedActivity averageSpeed(@Nullable Float averageSpeed) {
  ...
  public DetailedActivity maxSpeed(@Nullable Float maxSpeed) {
  ...
  public DetailedActivity hasKudoed(@Nullable Boolean hasKudoed) {
  ...
  public DetailedActivity hideFromHome(@Nullable Boolean hideFromHome) {
  ...
  public DetailedActivity gearId(@Nullable String gearId) {
    this.gearId = gearId;
    return this;
  }
  ...
  public DetailedActivity kilojoules(@Nullable Float kilojoules) {
  ...
  public DetailedActivity averageWatts(@Nullable Float averageWatts) {
  ...
  public DetailedActivity deviceWatts(@Nullable Boolean deviceWatts) {
  ...
  public DetailedActivity maxWatts(@Nullable Integer maxWatts) {
  ...
  public DetailedActivity weightedAverageWatts(@Nullable Integer weightedAverageWatts) {
  ...
  public DetailedActivity averageHeartrate(@Nullable Float averageHeartrate) {
  ...
  public DetailedActivity averageCadence(@Nullable Float averageCadence) {
  ...
  public DetailedActivity description(@Nullable String description) {
  ...
  public DetailedActivity photos(@Nullable PhotosSummary photos) {
    this.photos = photos;
    return this;
  }
  ...
  @JsonProperty("photos")
  public @Nullable PhotosSummary getPhotos() {
    return photos;
  }

  public void setPhotos(@Nullable PhotosSummary photos) {
    this.photos = photos;
  }

  public DetailedActivity gear(@Nullable SummaryGear gear) {
    this.gear = gear;
    return this;
  }
  ...
  @JsonProperty("gear")
  public @Nullable SummaryGear getGear() {
    return gear;
  }

  public void setGear(@Nullable SummaryGear gear) {
    this.gear = gear;
  }

  public DetailedActivity calories(@Nullable Float calories) {
  ...
  @Schema(name = "calories", description = "The number of kilocalories consumed during this activity", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("calories")
  public @Nullable Float getCalories() {
    return calories;
  }

  public void setCalories(@Nullable Float calories) {
    this.calories = calories;
  }
   ...
   */
  @Valid 
  @Schema(name = "segment_efforts", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public DetailedActivity embedToken(@Nullable String embedToken) {
  ...
  @Schema(name = "embed_token", description = "The token used to embed a Strava activity", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("embed_token")
  public @Nullable String getEmbedToken() {
    return embedToken;
  }

  public void setEmbedToken(@Nullable String embedToken) {
    this.embedToken = embedToken;
  }

  public DetailedActivity splitsMetric(List<@Valid Split> splitsMetric) {
   ...
   */
  @Valid 
  @Schema(name = "splits_metric", description = "The splits of this activity in metric units (for runs)", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("splits_metric")
  public List<@Valid Split> getSplitsMetric() {
    return splitsMetric;
  }

  public void setSplitsMetric(List<@Valid Split> splitsMetric) {
    this.splitsMetric = splitsMetric;
  }

  public DetailedActivity splitsStandard(List<@Valid Split> splitsStandard) {
   ...
   */
  @Valid 
  @Schema(name = "splits_standard", description = "The splits of this activity in imperial units (for runs)", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("splits_standard")
  public List<@Valid Split> getSplitsStandard() {
    return splitsStandard;
  }

  public void setSplitsStandard(List<@Valid Split> splitsStandard) {
    this.splitsStandard = splitsStandard;
  }

  public DetailedActivity laps(List<@Valid Lap> laps) {
    this.laps = laps;
    return this;
  }
   ...
   */
  @Valid 
  @Schema(name = "laps", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("laps")
  public List<@Valid Lap> getLaps() {
    return laps;
  }

  public void setLaps(List<@Valid Lap> laps) {
    this.laps = laps;
  }
   ...
   */
  @Valid 
  @Schema(name = "best_efforts", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
