...
public class BaseStream {
  ...
  public BaseStream originalSize(@Nullable Integer originalSize) {
  ...
  public BaseStream resolution(@Nullable ResolutionEnum resolution) {
  ...
  public BaseStream seriesType(@Nullable SeriesTypeEnum seriesType) {
