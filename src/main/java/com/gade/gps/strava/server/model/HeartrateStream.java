...
public class HeartrateStream {
  ...
  public HeartrateStream originalSize(@Nullable Integer originalSize) {
  ...
  public HeartrateStream resolution(@Nullable ResolutionEnum resolution) {
  ...
  public HeartrateStream seriesType(@Nullable SeriesTypeEnum seriesType) {
  ...
  @Schema(name = "data", description = "The sequence of heart rate values for this stream, in beats per minute", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("data")
