 ...
 */
@JsonPropertyOrder({
  SmoothGradeStream.JSON_PROPERTY_ORIGINAL_SIZE,
  SmoothGradeStream.JSON_PROPERTY_RESOLUTION,
  SmoothGradeStream.JSON_PROPERTY_SERIES_TYPE,
  SmoothGradeStream.JSON_PROPERTY_DATA
})
...
public class SmoothGradeStream {
  ...
  public SmoothGradeStream originalSize(@jakarta.annotation.Nullable Integer originalSize) {
  ...
  public SmoothGradeStream resolution(@jakarta.annotation.Nullable ResolutionEnum resolution) {
  ...
  public SmoothGradeStream seriesType(@jakarta.annotation.Nullable SeriesTypeEnum seriesType) {
  ...
  public SmoothGradeStream data(@jakarta.annotation.Nullable List<Float> data) {
