 ...
 */
@JsonPropertyOrder({
  CadenceStream.JSON_PROPERTY_ORIGINAL_SIZE,
  CadenceStream.JSON_PROPERTY_RESOLUTION,
  CadenceStream.JSON_PROPERTY_SERIES_TYPE,
  CadenceStream.JSON_PROPERTY_DATA
})
...
public class CadenceStream {
  ...
  public CadenceStream originalSize(@jakarta.annotation.Nullable Integer originalSize) {
  ...
  public CadenceStream resolution(@jakarta.annotation.Nullable ResolutionEnum resolution) {
  ...
  public CadenceStream seriesType(@jakarta.annotation.Nullable SeriesTypeEnum seriesType) {
  ...
  public CadenceStream data(@jakarta.annotation.Nullable List<Integer> data) {
