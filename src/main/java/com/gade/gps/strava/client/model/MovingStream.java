 ...
 */
@JsonPropertyOrder({
  MovingStream.JSON_PROPERTY_ORIGINAL_SIZE,
  MovingStream.JSON_PROPERTY_RESOLUTION,
  MovingStream.JSON_PROPERTY_SERIES_TYPE,
  MovingStream.JSON_PROPERTY_DATA
})
...
public class MovingStream {
  ...
  public MovingStream originalSize(@jakarta.annotation.Nullable Integer originalSize) {
  ...
  public MovingStream resolution(@jakarta.annotation.Nullable ResolutionEnum resolution) {
  ...
  public MovingStream seriesType(@jakarta.annotation.Nullable SeriesTypeEnum seriesType) {
  ...
  public MovingStream data(@jakarta.annotation.Nullable List<Boolean> data) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@jakarta.annotation.Nullable List<Boolean> data) {
    this.data = data;
  }
