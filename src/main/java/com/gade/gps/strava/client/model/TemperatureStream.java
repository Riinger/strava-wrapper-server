 ...
 */
@JsonPropertyOrder({
  TemperatureStream.JSON_PROPERTY_ORIGINAL_SIZE,
  TemperatureStream.JSON_PROPERTY_RESOLUTION,
  TemperatureStream.JSON_PROPERTY_SERIES_TYPE,
  TemperatureStream.JSON_PROPERTY_DATA
})
...
public class TemperatureStream {
  ...
  public TemperatureStream originalSize(@jakarta.annotation.Nullable Integer originalSize) {
  ...
  public TemperatureStream resolution(@jakarta.annotation.Nullable ResolutionEnum resolution) {
  ...
  public TemperatureStream seriesType(@jakarta.annotation.Nullable SeriesTypeEnum seriesType) {
  ...
  public TemperatureStream data(@jakarta.annotation.Nullable List<Integer> data) {
