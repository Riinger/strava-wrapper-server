 ...
 */
@JsonPropertyOrder({
  AltitudeStream.JSON_PROPERTY_ORIGINAL_SIZE,
  AltitudeStream.JSON_PROPERTY_RESOLUTION,
  AltitudeStream.JSON_PROPERTY_SERIES_TYPE,
  AltitudeStream.JSON_PROPERTY_DATA
})
...
public class AltitudeStream {
  ...
  public AltitudeStream originalSize(@jakarta.annotation.Nullable Integer originalSize) {
  ...
  public AltitudeStream resolution(@jakarta.annotation.Nullable ResolutionEnum resolution) {
  ...
  public AltitudeStream seriesType(@jakarta.annotation.Nullable SeriesTypeEnum seriesType) {
  ...
  public AltitudeStream data(@jakarta.annotation.Nullable List<Float> data) {
