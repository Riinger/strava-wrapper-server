 ...
 */
@JsonPropertyOrder({
  SmoothVelocityStream.JSON_PROPERTY_ORIGINAL_SIZE,
  SmoothVelocityStream.JSON_PROPERTY_RESOLUTION,
  SmoothVelocityStream.JSON_PROPERTY_SERIES_TYPE,
  SmoothVelocityStream.JSON_PROPERTY_DATA
})
...
public class SmoothVelocityStream {
  ...
  public SmoothVelocityStream originalSize(@jakarta.annotation.Nullable Integer originalSize) {
  ...
  public SmoothVelocityStream resolution(@jakarta.annotation.Nullable ResolutionEnum resolution) {
  ...
  public SmoothVelocityStream seriesType(@jakarta.annotation.Nullable SeriesTypeEnum seriesType) {
  ...
  public SmoothVelocityStream data(@jakarta.annotation.Nullable List<Float> data) {
