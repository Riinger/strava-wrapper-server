 ...
 */
@JsonPropertyOrder({
  PowerStream.JSON_PROPERTY_ORIGINAL_SIZE,
  PowerStream.JSON_PROPERTY_RESOLUTION,
  PowerStream.JSON_PROPERTY_SERIES_TYPE,
  PowerStream.JSON_PROPERTY_DATA
})
...
public class PowerStream {
  ...
  public PowerStream originalSize(@jakarta.annotation.Nullable Integer originalSize) {
  ...
  public PowerStream resolution(@jakarta.annotation.Nullable ResolutionEnum resolution) {
  ...
  public PowerStream seriesType(@jakarta.annotation.Nullable SeriesTypeEnum seriesType) {
  ...
  public PowerStream data(@jakarta.annotation.Nullable List<Integer> data) {
