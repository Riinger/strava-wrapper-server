 ...
 */
@JsonPropertyOrder({
  LatLngStream.JSON_PROPERTY_ORIGINAL_SIZE,
  LatLngStream.JSON_PROPERTY_RESOLUTION,
  LatLngStream.JSON_PROPERTY_SERIES_TYPE,
  LatLngStream.JSON_PROPERTY_DATA
})
...
public class LatLngStream {
  ...
  public LatLngStream originalSize(@jakarta.annotation.Nullable Integer originalSize) {
  ...
  public LatLngStream resolution(@jakarta.annotation.Nullable ResolutionEnum resolution) {
  ...
  public LatLngStream seriesType(@jakarta.annotation.Nullable SeriesTypeEnum seriesType) {
  ...
  public LatLngStream data(@jakarta.annotation.Nullable List<List<Float>> data) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@jakarta.annotation.Nullable List<List<Float>> data) {
    this.data = data;
  }
