 ...
 */
@JsonPropertyOrder({
  HeartrateStream.JSON_PROPERTY_ORIGINAL_SIZE,
  HeartrateStream.JSON_PROPERTY_RESOLUTION,
  HeartrateStream.JSON_PROPERTY_SERIES_TYPE,
  HeartrateStream.JSON_PROPERTY_DATA
})
...
public class HeartrateStream {
  ...
  public HeartrateStream originalSize(@jakarta.annotation.Nullable Integer originalSize) {
  ...
  public HeartrateStream resolution(@jakarta.annotation.Nullable ResolutionEnum resolution) {
  ...
  public HeartrateStream seriesType(@jakarta.annotation.Nullable SeriesTypeEnum seriesType) {
  ...
  public HeartrateStream data(@jakarta.annotation.Nullable List<Integer> data) {
